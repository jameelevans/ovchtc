                                            ...
                                            <div class="improve-training__details">
                                                ...
                                                if(get_field('download_pdf')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        ...
                                                        <a class="improve-training__cta" href="<?php echo $oppdf['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_2')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $oppdf2['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_2")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_3')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $oppdf3['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_3")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_4')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $oppdf4['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_4")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_5')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $oppdf5['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_5")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_6')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $oppdf6['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_6")?>)</a>
                                                </div>
                                                <?php }
                                            ...
                                            <div class="improve-training__details">
                                                ...
                                                if(get_field('download_pdf')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $atrpdf['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_2')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $atrpdf2['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_2")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_3')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $atrpdf3['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_3")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_4')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $atrpdf4['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_4")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_5')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $atrpdf5['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_5")?>)</a>
                                                    </div>
                                                <?php }
                                                ...
                                                if(get_field('download_pdf_6')){?>
                                                    <div class="improve-training__cta--wrapper">
                                                        <?php echo svg_icon('improve-training__icon', 'download');?>
                                                        <!--Improve Training download link  -->
                                                        <a class="improve-training__cta" href="<?php echo $atrpdf6['url']; ?>" target="_blank" download>Download PDF (<?php the_field("download_size_6")?>)</a>
                                                </div>
                                                <?php }
                                                }?>
                                            </div>
