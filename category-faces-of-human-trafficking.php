    ...
    <section class="categories">
        <div class="categories__wrapper">
            <div class="categories__header">
                ...
                <p class="categories__subheader categories__subheader--mobile">In 2015, The Office for Victims of Crime (OVC) launched the “Faces of Human
                Trafficking” (FOHT) training series to raise awareness and educate the public about the
                impact of human trafficking. This comprehensive series included nine powerful videos
                and discussion guides that delved into various aspects of trafficking. These materials
                provided crucial insights into understanding the crime, offering effective victim services,
                and addressing the legal needs and rights of victims. Most importantly, the series
                amplified the voices of survivors, sharing beyond hard experiences and showcasing
                inspiring resilience. </p>
                <p class="categories__subheader categories__subheader--mobile">Over the past ten years, the foundations laid by this series have remained, while encouraging
                new pathways to emerge, driving forward efforts against trafficking. We invite you to
                read blog posts from some of the original participants, reflecting on the series and
                sharing their perspectives on the future of the anti-trafficking sector.  As we review the
                progression of our initiatives, from the FOHT series to the current state of awareness
                and survivor-led programs, it is important to recognize the impact of our collective effort
                to continue to question, challenge, and develop our response to the needs of every
                community impacted by exploitation.</p>
                <div class="categories__sort">
                    <?php sort_webinar_posts(); ?>
                </div>
            </div>
            <p class="categories__subheader categories__subheader--desktop">In 2015, The Office for Victims of Crime (OVC) launched the “Faces of Human
Trafficking” (FOHT) training series to raise awareness and educate the public about the
impact of human trafficking. This comprehensive series included nine powerful videos
and discussion guides that delved into various aspects of trafficking. These materials
provided crucial insights into understanding the crime, offering effective victim services,
...
amplified the voices of survivors, sharing beyond hard experiences and showcasing
inspiring resilience. </p>
<p class="categories__subheader categories__subheader--desktop">Over the past ten years, the foundations laid by this series have remained, while encouraging
new pathways to emerge, driving forward efforts against trafficking. We invite you to
read blog posts from some of the original participants, reflecting on the series and
sharing their perspectives on the future of the anti-trafficking sector.  As we review the
progression of our initiatives, from the FOHT series to the current state of awareness
